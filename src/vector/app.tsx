...
export async function loadApp(fragParams: {}, matrixChatRef: React.Ref<MatrixChat>): Promise<ReactElement> {
    ...
    style.textContent = `
        ...
        .mx_RoomView_wrapper .mx_SearchWarning,
        li[role="menuitem"][aria-label="View source"],
        #matrixchat .mx_LoginSplashView_splashButtons,
        .mx_Dialog_wrapper .mx_InviteDialog_identityServer, 
        ...
        .mx_AppTileMenuBar .mx_AppTileMenuBar_title span b::before {
            content: "Gabay" !important;
